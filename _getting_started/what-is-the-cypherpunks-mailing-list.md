...
+ 2000-2013 - _The list operated via a distributed architecture using the Majordomo mailing list software with a peak of 7 nodes. By mid-2005 al-qaeda.net hosted the only remaining node. Mailing list archives are not available for this period although I'm pursuing lines of enquiry that might be able to produce them._
